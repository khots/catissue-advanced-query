...
<%@ page
	import="edu.wustl.query.util.global.Constants,edu.wustl.common.util.global.ApplicationProperties,edu.wustl.query.util.global.Variables,edu.wustl.common.beans.SessionDataBean"%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<table width="95%" border="0" cellpadding="0" cellspacing="0">
			<tr>
					...
					<tr class="wh_ar_b">
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td><img
									src="images/advancequery/uIEnhancementImages/table_title_corner.gif"
				...
				<td width="5"
					background="images/advancequery/uIEnhancementImages/shadow_right.gif" style="background-repeat: repeat-y"></td>

			</tr>
			<tr>
				<td background="images/advancequery/uIEnhancementImages/shadow_down.gif"></td>
				<td><img src="images/advancequery/uIEnhancementImages/shadow_corner.gif" 
				alt="Shadow Corner"
					width="5" height="5" /></td>
			</tr>
		</table>
		...
		<td width="0%" rowspan="3" valign="top"><img
			src="images/advancequery/uIEnhancementImages/sep_left.gif" width="8" height="458" /></td>
		<td width="49%" rowspan="3" align="center" valign="top"><img
			src="images/advancequery/uIEnhancementImages/concept_image_s.jpg"
			alt="caTissue Suite" width="450" height="470" /></td>

		<td width="0%" rowspan="3" valign="top"><img
			src="images/advancequery/uIEnhancementImages/sep_right.gif" width="8" height="458" /></td>
		...
		<table width="95%" border="0" cellpadding="0" cellspacing="0">
			<tr>
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td><img src="images/advancequery/uIEnhancementImages/or_dot.gif"
												 alt="Divider line"
				...
				<td width="5"
					background="images/advancequery/uIEnhancementImages/shadow_right.gif"></td>
			</tr>
			<tr>
				<td background="images/advancequery/uIEnhancementImages/shadow_down.gif"></td>
				<td><img src="images/advancequery/uIEnhancementImages/shadow_corner.gif"
	...
	<tr>
		...
		<table width="96%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td class="black_ar"><img
					src="images/advancequery/uIEnhancementImages/logo_windows.gif" alt="Windows "
					width="16" height="16" hspace="3" vspace="3" align="absmiddle" /><bean:message
					key="app.optimal.resolutions.win" /><br />
				<img src="images/advancequery/uIEnhancementImages/logo_mac.gif" alt="Mac"
					width="16" height="16" hspace="3" vspace="3" align="absmiddle" /><bean:message
	...
	<tr>
		...
		<table width="95%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="center"
					background="images/advancequery/uIEnhancementImages/box_bg.gif"
