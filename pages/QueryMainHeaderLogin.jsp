...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td valign="top"><img
			src="images/advancequery/uIEnhancementImages/top_bg1.jpg" alt="Top corner"
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="50%" align="right" valign="top"><a
					...
					src="images/advancequery/uIEnhancementImages/ic_report.gif" alt="Report Problems" width="15"
