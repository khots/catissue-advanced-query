...
create table DYEXTN_CONTROL (IDENTIFIER bigint not null auto_increment, CAPTION varchar(255), CSS_CLASS varchar(255), HIDDEN bit, NAME varchar(255), SEQUENCE_NUMBER integer, TOOLTIP varchar(255), CONTAINER_ID bigint, BASE_ABST_ATR_ID bigint, READ_ONLY bit, primary key (IDENTIFIER));
