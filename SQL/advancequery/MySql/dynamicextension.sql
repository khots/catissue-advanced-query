...
=======
drop table if exists DYEXT_ENTIY_COMPOSITE_KEY_REL;
>>>>>>> .merge-right.r6499
...
create table DYEXTN_CATEGORY_ATTRIBUTE (IDENTIFIER bigint not null, ABSTRACT_ATTRIBUTE_ID bigint, CATEGORY_ENTIY_ID bigint, IS_VISIBLE bit, IS_RELATTRIBUTE bit, CATEGORY_ENTITY_ID bigint, primary key (IDENTIFIER));
...
create table DYEXTN_CONTAINER (IDENTIFIER bigint not null auto_increment, BUTTON_CSS varchar(255), CAPTION text, ABSTRACT_ENTITY_ID bigint, MAIN_TABLE_CSS varchar(255), REQUIRED_FIELD_INDICATOR varchar(255), REQUIRED_FIELD_WARNING_MESSAGE varchar(255), TITLE_CSS varchar(255), BASE_CONTAINER_ID bigint, ADD_CAPTION bit, ENTITY_GROUP_ID bigint, VIEW_ID bigint, primary key (IDENTIFIER));
create table DYEXTN_CONTAINMENT_CONTROL (IDENTIFIER bigint not null, primary key (IDENTIFIER));
create table DYEXTN_CONTROL (IDENTIFIER bigint not null auto_increment, CAPTION text, CSS_CLASS varchar(255), HIDDEN bit, NAME varchar(255), SEQUENCE_NUMBER integer, TOOLTIP varchar(255), CONTAINER_ID bigint, BASE_ABST_ATR_ID bigint, READ_ONLY bit, HEADING varchar(255), primary key (IDENTIFIER));
...
create table DYEXTN_LIST_BOX (IDENTIFIER bigint not null, NO_OF_ROWS integer, MULTISELECT bit, primary key (IDENTIFIER));
...
drop table if exists dyextn_id_generator;
create table DE_COLL_ATTR_RECORD_VALUES (IDENTIFIER bigint not null auto_increment, RECORD_VALUE text, COLLECTION_ATTR_RECORD_ID bigint, primary key (IDENTIFIER));
create table DE_FILE_ATTR_RECORD_VALUES (IDENTIFIER bigint not null auto_increment, CONTENT_TYPE varchar(255), FILE_CONTENT longblob, FILE_NAME varchar(255), RECORD_ID bigint, primary key (IDENTIFIER));
create table DE_OBJECT_ATTR_RECORD_VALUES (IDENTIFIER bigint not null auto_increment, CLASS_NAME varchar(255), OBJECT_CONTENT longblob, RECORD_ID bigint, primary key (IDENTIFIER));
=======
create table DE_FILE_ATTR_RECORD_VALUES (IDENTIFIER bigint not null auto_increment, CONTENT_TYPE varchar(255), FILE_CONTENT blob, FILE_NAME varchar(255), RECORD_ID bigint, primary key (IDENTIFIER));
create table DE_OBJECT_ATTR_RECORD_VALUES (IDENTIFIER bigint not null auto_increment, CLASS_NAME varchar(255), OBJECT_CONTENT blob, RECORD_ID bigint, primary key (IDENTIFIER));
>>>>>>> .merge-right.r6499
...
create table DYEXTN_CONTAINER (IDENTIFIER bigint not null auto_increment, BUTTON_CSS varchar(255), CAPTION text, ABSTRACT_ENTITY_ID bigint, MAIN_TABLE_CSS varchar(255), REQUIRED_FIELD_INDICATOR varchar(255), REQUIRED_FIELD_WARNING_MESSAGE varchar(255), TITLE_CSS varchar(255), BASE_CONTAINER_ID bigint, ADD_CAPTION bit, ENTITY_GROUP_ID bigint, VIEW_ID bigint, primary key (IDENTIFIER));
create table DYEXTN_CONTAINMENT_CONTROL (IDENTIFIER bigint not null, primary key (IDENTIFIER));
create table DYEXTN_CONTROL (IDENTIFIER bigint not null auto_increment, CAPTION text, CSS_CLASS varchar(255), HIDDEN bit, NAME varchar(255), SEQUENCE_NUMBER integer, TOOLTIP varchar(255), CONTAINER_ID bigint, BASE_ABST_ATR_ID bigint, READ_ONLY bit, primary key (IDENTIFIER));
create table DYEXTN_DATABASE_PROPERTIES (IDENTIFIER bigint not null auto_increment, NAME varchar(255), primary key (IDENTIFIER));
create table DYEXTN_DATA_ELEMENT (IDENTIFIER bigint not null auto_increment, CATEGORY_ATTRIBUTE_ID bigint, ATTRIBUTE_TYPE_INFO_ID bigint, primary key (IDENTIFIER));
create table DYEXTN_DATA_GRID (IDENTIFIER bigint not null, primary key (IDENTIFIER));
create table DYEXTN_DATEPICKER (IDENTIFIER bigint not null, DATE_VALUE_TYPE varchar(255), primary key (IDENTIFIER));
...
create table DYEXTN_USERDEF_DE_VALUE_REL (USER_DEF_DE_ID bigint not null, PERMISSIBLE_VALUE_ID bigint not null, primary key (USER_DEF_DE_ID, PERMISSIBLE_VALUE_ID));
create table DYEXTN_VIEW (IDENTIFIER bigint not null auto_increment, NAME varchar(255), primary key (IDENTIFIER));
create table DYEXT_ENTIY_COMPOSITE_KEY_REL (ENTITY_ID bigint not null, ATTRIBUTE_ID bigint not null, INSERTION_ORDER integer not null, primary key (ENTITY_ID, INSERTION_ORDER));
create table dyextn_id_generator (id bigint not null, next_available_id bigint, primary key (id));
alter table DE_COLL_ATTR_RECORD_VALUES add index FK847DA57775255CA5 (COLLECTION_ATTR_RECORD_ID), add constraint FK847DA57775255CA5 foreign key (COLLECTION_ATTR_RECORD_ID) references DYEXTN_ATTRIBUTE_RECORD (IDENTIFIER);
alter table DE_FILE_ATTR_RECORD_VALUES add index FKE68334E74EB991B2 (RECORD_ID), add constraint FKE68334E74EB991B2 foreign key (RECORD_ID) references DYEXTN_ATTRIBUTE_RECORD (IDENTIFIER);
alter table DE_OBJECT_ATTR_RECORD_VALUES add index FK504EADC44EB991B2 (RECORD_ID), add constraint FK504EADC44EB991B2 foreign key (RECORD_ID) references DYEXTN_ATTRIBUTE_RECORD (IDENTIFIER);
...
>>>>>>> .merge-right.r4799
=======
alter table DYEXT_ENTIY_COMPOSITE_KEY_REL add index FKD2168AAA4AC41F7E (ENTITY_ID), add constraint FKD2168AAA4AC41F7E foreign key (ENTITY_ID) references DYEXTN_ENTITY (IDENTIFIER);
alter table DYEXT_ENTIY_COMPOSITE_KEY_REL add index FKD2168AAA4DC2CD16 (ATTRIBUTE_ID), add constraint FKD2168AAA4DC2CD16 foreign key (ATTRIBUTE_ID) references DYEXTN_PRIMITIVE_ATTRIBUTE (IDENTIFIER);
>>>>>>> .merge-right.r6499
