...
create table QUERY (IDENTIFIER bigint generated by default as identity , CONSTRAINTS_ID bigint not null unique, primary key (IDENTIFIER));
create table QUERY_ARITHMETIC_OPERAND (IDENTIFIER bigint generated by default as identity, LITERAL varchar(255), TERM_TYPE varchar(255), DATE_LITERAL date, TIME_INTERVAL varchar(255), DE_ATTRIBUTE_ID bigint, EXPRESSION_ID bigint, primary key (IDENTIFIER));
...
create table QUERY_CONSTRAINTS (IDENTIFIER bigint generated by default as identity , QUERY_JOIN_GRAPH_ID bigint not null unique, primary key (IDENTIFIER));
...
create table QUERY_CUSTOM_FORMULA (IDENTIFIER bigint generated by default as identity, OPERATOR varchar(255), LHS_TERM_ID bigint, primary key (IDENTIFIER));
create table QUERY_EXPRESSION (IDENTIFIER bigint generated by default as identity, IS_IN_VIEW DECIMAL(1,0), IS_VISIBLE DECIMAL(1,0), UI_EXPR_ID integer, QUERY_ENTITY_ID bigint, primary key (IDENTIFIER));
...
create table QUERY_INTER_MODEL_ASSOCIATION (IDENTIFIER bigint generated by default as identity, SOURCE_SERVICE_URL varchar(1000) not null, TARGET_SERVICE_URL varchar(1000) not null, SOURCE_ATTRIBUTE_ID bigint not null, TARGET_ATTRIBUTE_ID bigint not null, primary key (IDENTIFIER));
create table QUERY_INTRA_MODEL_ASSOCIATION (IDENTIFIER bigint generated by default as identity, DE_ASSOCIATION_ID bigint not null, primary key (IDENTIFIER));
...
create table QUERY_OUTPUT_ATTRIBUTE (IDENTIFIER bigint generated by default as identity , EXPRESSION_ID bigint, ATTRIBUTE_ID bigint not null, PARAMETERIZED_QUERY_ID bigint, POSITION integer, primary key (IDENTIFIER));
...
create table QUERY_PARAMETERIZED_QUERY (IDENTIFIER bigint generated by default as identity, QUERY_NAME varchar(255) not null unique, DESCRIPTION varchar(1024), primary key (IDENTIFIER));
...
create table QUERY_SUBEXPR_OPERAND (IDENTIFIER bigint generated by default as identity, EXPRESSION_ID bigint, primary key (IDENTIFIER));
