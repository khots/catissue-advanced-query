...
create table QUERY_ABSTRACT_QUERY (IDENTIFIER bigint generated by default as identity, QUERY_NAME varchar(255), QUERY_TYPE varchar(255), DESCRIPTION varchar(1024), primary key (IDENTIFIER));
...
create table QUERY_WORKFLOW (IDENTIFIER bigint not null generated by default as identity, USER_ID bigint, WORKFLOW_NAME varchar(1024), CREATED_ON date, primary key (IDENTIFIER));
