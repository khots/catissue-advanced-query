...
create table QUERY_WORKFLOW (IDENTIFIER bigint not null generated by default as identity, USER_ID bigint, QUERY_NAME varchar(1024), CREATED_ON date, primary key (IDENTIFIER));
