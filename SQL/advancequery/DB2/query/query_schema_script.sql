...
create table QUERY_ABSTRACT_QUERY (IDENTIFIER bigint generated by default as identity, QUERY_NAME varchar(255), DESCRIPTION varchar(1024), primary key (IDENTIFIER));
