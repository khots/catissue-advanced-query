...
drop table DYEXT_ENTIY_COMPOSITE_KEY_REL;
...
create table DYEXTN_CONTROL (IDENTIFIER bigint generated by default as identity, CAPTION varchar(800), CSS_CLASS varchar(255), HIDDEN smallint, NAME varchar(255), SEQUENCE_NUMBER integer, TOOLTIP varchar(255), CONTAINER_ID bigint, BASE_ABST_ATR_ID bigint, READ_ONLY smallint, primary key (IDENTIFIER));
...
alter table DYEXT_ENTIY_COMPOSITE_KEY_REL add constraint FKD2168AAA4AC41F7E foreign key (ENTITY_ID) references DYEXTN_ENTITY;
alter table DYEXT_ENTIY_COMPOSITE_KEY_REL add constraint FKD2168AAA4DC2CD16 foreign key (ATTRIBUTE_ID) references DYEXTN_PRIMITIVE_ATTRIBUTE;
