...
create table PATH (PATH_ID bigint generated by default as identity, FIRST_ENTITY_ID bigint default null, INTERMEDIATE_PATH varchar(1000) default null, LAST_ENTITY_ID bigint default null, primary key (PATH_ID));
