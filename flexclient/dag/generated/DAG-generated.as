 ...
 *	Package:	
 *	Class: 		DAG
 *	Source: 	F:\workspace\catissuecore_New_1\flexclient\dag\DAG.mxml
 *	Template: 	flex2/compiler/mxml/gen/ClassDef.vm
 *	Time: 		2008.09.11 17:57:32 GMT+05:30
 */
...
new mx.core.UIComponentDescriptor({
  ...
  propertiesFactory: function():Object { return {
                      ...
                      ,
                        new mx.core.UIComponentDescriptor({
                          ...
                          propertiesFactory: function():Object { return {
                            ...
                            toolTip: "Create temporal query on selected nodes"
                          }}
                        })
                      ]
                    }}
	...
	public function DAG()
	{
		...
		this.addEventListener("dragExit", ___Application1_dragExit);
	...
	*/
	private function initApp():void
	{
		...
		registerClassAlias("edu.wustl.catissuecore.flex.dag.SingleNodeCustomFormulaNode",SingleNodeCustomFormulaNode);
	...
	*/
	public function linkNodesHandler(event: ResultEvent):void
	{
		...
		if(selectedList!=null)
		{
			...
			{
				AlertManager.showWarning("Cannot connect selected nodes as it creates cycle in the query graph");
			}
				
		}
		else
		{
			AlertManager.showWarning("No association present or no association selected.");
		}
...
/*	//code for multiple association
	...
	*/
	private function drawLine():void{
		...
		{
			AlertManager.showWarning("Please select two nodes to link");
		...
		else
		{
			...
			{
				AlertManager.showWarning("An association already exists between selected nodes");
		  		CursorManager.removeBusyCursor();   	   
			}
			else
			{
    ...
    */
	public function clearPaths():void
	{
	 ...
	 private function singleNodeValidityHandler(event : ResultEvent) : void
	 {
	 	...
	 	{
	 	     AlertManager.showWarning("Node is not valid for Temporal Query");	
	 	}
	 }
	...
	private function nodeValidityHandler(event : ResultEvent):void
	{
		...
		{
			 AlertManager.showWarning("Nodes are not valid for Temporal Query");
		}
	}
...
private function _RemoteObject1_i() : mx.rpc.remoting.mxml.RemoteObject
{
	...
	rpcService = temp;
	temp.destination = "cdeService";
	temp.operations = {};
	temp.initialized(this, "rpcService")
	return temp;
}
...
public function ___Application1_dragExit(event:mx.events.DragEvent):void
{
	onDragExit(event)
}
...
public function __TQBtn_click(event:flash.events.MouseEvent):void
{
	openTQPopUp()
}
	...
	mx_internal function _DAG_StylesInit():void
	{
		...
		if (style.factory == null)
		{
			...
			{
				this.color = 0x0f3177;
				this.dropShadowColor = 0xd1ddf7;
				this.footerColors = [0x9db6d9, 0xffffff];
				this.headerColors = [0x90a4d1, 0x5970a0];
				this.backgroundColor = 0xffffff;
				this.borderColor = 0x5970a0;
		...
		var styleNames:Array = [  "fontWeight",  "verticalGridLineColor",  "textAlign",  "todayColor",  "disabledColor",  "dropShadowColor",  "fontThickness",  "textIndent",  "footerColors",  "fontFamily",  "errorColor",  "modalTransparencyBlur",  "backgroundDisabledColor",  "barColor",  "fontStyle",  "modalTransparencyDuration",  "horizontalGridLineColor",  "fontGridFitType",  "modalTransparencyColor",  "alternatingItemColors",  "fontSharpness",  "rollOverColor",  "textRollOverColor",  "fontSize",  "dropdownBorderColor",  "textSelectedColor",  "modalTransparency",  "selectionColor",  "selectionDisabledColor",  "fontAntiAliasType",  "themeColor",  "color",  "headerColors",  ];
