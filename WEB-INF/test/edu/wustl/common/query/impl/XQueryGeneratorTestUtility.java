 ...
 * 
 */
public class XQueryGeneratorTestUtility
{
	 ...
	 */
	public static ICondition createCondition(EntityInterface personEntity)
	{
	...
	public static IRule createPersonRule1(EntityInterface personEntity)
	{
		...
		conditions.add(createCondition(personEntity));
	 ...
	 * @return The Condition object.
	 */
	public static ICondition createPersonCondition2(EntityInterface personEntity,
	 ...
	 * @return The Rule reference.
	 */
	public static IRule createPersonRule2(EntityInterface personEntity,
			RelationalOperator relationalOperator)
	{
		List<ICondition> conditions = new ArrayList<ICondition>();
	...
	public static IQuery createQuery1()
	{
		...
		try
		{
			...
			EntityInterface personEntity = entityManager
					.getEntityByName(XQueryEntityManagerMock.PERSON);
			IQueryEntity personConstraintEntity = QueryObjectFactory
					.createQueryEntity(personEntity);
	...
	public static ICondition createDemographicsCondition1(EntityInterface demographicsEntity)
	{
		...
		ICondition condition = QueryObjectFactory.createCondition(attribute,
				RelationalOperator.GreaterThan, values);
	...
	public static ICondition createDemographicsCondition2(EntityInterface demographicsEntity)
	{
		...
		AttributeInterface attribute = findAttribute(demographicsEntity, "dateOfBirth");
		ICondition condition = QueryObjectFactory.createCondition(attribute,
				RelationalOperator.LessThan, values);
	...
	public static ICondition createDemographicsCondition3(EntityInterface demographicsEntity)
	{
		...
		AttributeInterface attribute = findAttribute(demographicsEntity, "dateOfBirth");
		ICondition condition = QueryObjectFactory.createCondition(attribute,
				RelationalOperator.Between, values);
	...
	public static IQuery createQuery2()
	{
		...
		try
		{
			...
			EntityInterface demographicsEntity = entityManager
					.getEntityByName(XQueryEntityManagerMock.DEMOGRAPHICS);
			IQueryEntity demographicsConstraintEntity = QueryObjectFactory
					.createQueryEntity(demographicsEntity);
			IExpression demographicsExpression = constraints
					.addExpression(demographicsConstraintEntity);
			...
			AssociationInterface personAndDemographicsAssociation = getAssociationFrom(
					entityManager.getAssociations(personEntity.getId(), demographicsEntity.getId()),
			...
			joinGraph.putAssociation(personExpression, demographicsExpression, association);
	...
	public static IQuery createQuery3()
	{
		...
		try
		{
			...
			EntityInterface raceEntity = entityManager
					.getEntityByName(XQueryEntityManagerMock.RACE);
			...
			EntityInterface genderEntity = entityManager
					.getEntityByName(XQueryEntityManagerMock.GENDER);
			IQueryEntity genderConstraintEntity = QueryObjectFactory
					.createQueryEntity(genderEntity);
			...
			IIntraModelAssociation association1 = QueryObjectFactory
					.createIntraModelAssociation(personAndDemographicsAssociation);
			joinGraph.putAssociation(personExpression, demographicsExpression, association1);

			AssociationInterface demographicsAndRaceAssociation = getAssociationFrom(entityManager
					.getAssociations(demographicsEntity.getId(), raceEntity.getId()),
					XQueryEntityManagerMock.RACE);
			IIntraModelAssociation association2 = QueryObjectFactory
					.createIntraModelAssociation(demographicsAndRaceAssociation);
			joinGraph.putAssociation(demographicsExpression, raceExpression, association2);

			AssociationInterface demographicsAndGenderAssociation = getAssociationFrom(
					entityManager.getAssociations(demographicsEntity.getId(), genderEntity.getId()),
					XQueryEntityManagerMock.GENDER);
			IIntraModelAssociation association3 = QueryObjectFactory
					.createIntraModelAssociation(demographicsAndGenderAssociation);
			joinGraph.putAssociation(demographicsExpression, genderExpression, association3);
	...
	public static IQuery createQuery8()
	{
		...
		try
		{
			...
			IExpression personExpression = constraints.addExpression(personConstraintEntity);
			personExpression
					.addOperand(createPersonRule2(personEntity, RelationalOperator.Contains));
	...
	public static IQuery createQuery11()
	{
		...
		try
		{
			...
			EntityInterface labProcedureEntity = entityManager
					.getEntityByName(XQueryEntityManagerMock.LABORATORY_PROCEDURE);
			IQueryEntity labProcedureConstraintEntity = QueryObjectFactory
					.createQueryEntity(labProcedureEntity);
			IExpression labProcedureExpression = constraints
					.addExpression(labProcedureConstraintEntity);
			...
			// Adding association to Join graph.
			AssociationInterface personAndLabProcedureAssociation = getAssociationFrom(
					entityManager.getAssociations(personEntity.getId(), labProcedureEntity.getId()),
					XQueryEntityManagerMock.LABORATORY_PROCEDURE);
			IIntraModelAssociation association = QueryObjectFactory
					.createIntraModelAssociation(personAndLabProcedureAssociation);
			joinGraph.putAssociation(personExpression, labProcedureExpression, association);
