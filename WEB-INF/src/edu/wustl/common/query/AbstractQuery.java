...
public abstract class AbstractQuery
{
	 ...
	 * @param userId
	 */
	public AbstractQuery(IAbstractQuery query, Long queryExecId, String queryString, Long userId, String ipAddress)
	{
		this.query = query;
   ...
   /**
     ...
     * @param workflowId
     */
    public AbstractQuery(IAbstractQuery query, Long queryExecId,
	 ...
	 * @param queryExecId
	 */
	public void setQueryExecId(Long queryExecId)
	{
		this.queryExecId = queryExecId;
	}
