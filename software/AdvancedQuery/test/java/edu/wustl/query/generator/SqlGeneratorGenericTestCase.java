...
public class SqlGeneratorGenericTestCase extends TestCase
{
    ...
    public void testParticipantQuery()
    {
        ...
        try
        {
            ...
            assertEqualSql(
                    ...
                    "select distinct Participant_1.BIRTH_DATE Column0, Participant_1.DEATH_DATE Column1, Participant_1.EMPI_ID Column2, Participant_1.LNAME_METAPHONE Column3, Participant_1.ACTIVITY_STATUS Column4, Participant_1.EMPI_ID_STATUS Column5, Participant_1.VITAL_STATUS Column6, Participant_1.SOCIAL_SECURITY_NUMBER Column7, Participant_1.GENOTYPE Column8, Participant_1.MIDDLE_NAME Column9, Participant_1.LAST_NAME Column10, Participant_1.IDENTIFIER Column11, Participant_1.GENDER Column12, Participant_1.FIRST_NAME Column13, Participant_1.ETHNICITY Column14  from (select * from CATISSUE_PARTICIPANT where ACTIVITY_STATUS != 'Disabled') Participant_1  where lower(Participant_1.ACTIVITY_STATUS) = lower(?)",
                    sql);
        }
        catch (Exception e)
        {
    ...
    public void testTemporalPartCPR()
    {
        ...
        try
        {
            ...
            assertEqualSql(
                    "Incorrect SQL formed for Query !!!",
                    "select distinct Participant_1.BIRTH_DATE Column0, Participant_1.DEATH_DATE Column1," +
                    " Participant_1.EMPI_ID Column2, Participant_1.LNAME_METAPHONE Column3," +
                    " Participant_1.ACTIVITY_STATUS Column4, Participant_1.EMPI_ID_STATUS Column5," +
                    " Participant_1.VITAL_STATUS Column6, Participant_1.SOCIAL_SECURITY_NUMBER Column7," +
                    " Participant_1.GENOTYPE Column8, Participant_1.MIDDLE_NAME Column9," +
                    " Participant_1.LAST_NAME Column10, Participant_1.IDENTIFIER Column11," +
                    " Participant_1.GENDER Column12, Participant_1.FIRST_NAME Column13," +
                    " Participant_1.ETHNICITY Column14  from (select * from CATISSUE_PARTICIPANT where" +
