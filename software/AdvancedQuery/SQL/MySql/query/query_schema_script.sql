...
create table QUERY_PARAMETERIZED_QUERY (IDENTIFIER bigint not null, QUERY_NAME varchar(255) not null unique, SHOW_TREE tinyint(1) default NULL,DESCRIPTION text, primary key (IDENTIFIER));
