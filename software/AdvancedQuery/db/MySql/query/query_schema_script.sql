...
create table QUERY_PARAMETERIZED_QUERY (IDENTIFIER bigint not null, QUERY_NAME varchar(255) not null unique, DESCRIPTION text, SHOW_TREE bit default 0, primary key (IDENTIFIER));
