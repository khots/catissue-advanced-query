...
drop table QUERY_WORKFLOW;
drop table QUERY_WORKFLOW_ITEM;
create table
COMMONS_GRAPH 
...
create table QUERY_ABSTRACT_QUERY (IDENTIFIER bigint generated by default as identity, QUERY_NAME varchar(255), QUERY_TYPE varchar(30), DESCRIPTION varchar(1024), CREATED_DATE timestamp not null, CREATED_BY bigint not null, UPDATION_DATE timestamp not null, UPDATED_BY bigint not null, primary key (IDENTIFIER));
...
create table QUERY_CONDITION_VALUES (CONDITION_ID bigint not null, VALUE varchar(355), POSITION integer not null, primary key (CONDITION_ID, POSITION));
...
create table QUERY_WORKFLOW (IDENTIFIER bigint not null generated by default as identity, USER_ID bigint, WORKFLOW_NAME varchar(1024), CREATED_ON date, WORKFLOW_DESCRIPTION varchar(1024), primary key (IDENTIFIER));
create table QUERY_WORKFLOW_ITEM (IDENTIFIER bigint not null generated by default as identity, QUERY_ID bigint, WORKFLOW_ID bigint, POSITION integer, primary key (IDENTIFIER));
...
drop table EXECUTION_TO_OUTPUT_TERMS;
drop table EXECUTION_TO_OUTPUT_PARAMETERS;
drop table EXECUTION_TO_OUTPUT_ATTRIBUTE;
create table EXECUTION (IDENTIFIER bigint not null, CONSTRAINTS_ID bigint, primary key (IDENTIFIER));
create table EXECUTION_TO_OUTPUT_TERMS (EXECUTION_ID bigint not null, OUTPUT_TERM_ID bigint not null unique, POSITION integer not null, primary key (EXECUTION_ID, POSITION));
alter table EXECUTION_TO_OUTPUT_TERMS add constraint FK8A70E25691051647 foreign key (EXECUTION_ID) references EXECUTION;
create table EXECUTION_TO_OUTPUT_PARAMETERS (EXECUTION_ID bigint not null, PARAMETER_ID bigint not null unique, POSITION integer not null, primary key (EXECUTION_ID, POSITION));
alter table EXECUTION_TO_OUTPUT_PARAMETERS add constraint FK8060DAD739F0ADDD foreign key (EXECUTION_ID) references EXECUTION;
alter table EXECUTION_TO_OUTPUT_PARAMETERS add constraint FK8060DAD7F84B9DDD foreign key (PARAMETER_ID) references QUERY_PARAMETER;
create table EXECUTION_TO_OUTPUT_ATTRIBUTE (IDENTIFIER bigint generated by default as identity, EXPRESSION_ID bigint, ATTRIBUTE_ID bigint not null, EXECUTION_ID bigint, POSITION integer, DATA_VIEW_ID bigint, primary key (IDENTIFIER));
alter table EXECUTION_TO_OUTPUT_ATTRIBUTE add constraint FK22C9DB75E92C8D41 foreign key (EXPRESSION_ID) references QUERY_BASE_EXPRESSION;
alter table EXECUTION_TO_OUTPUT_ATTRIBUTE add constraint FK22C9DB75F961B22E foreign key (DATA_VIEW_ID) references QUERY_DATA_VIEW;
alter table EXECUTION_TO_OUTPUT_ATTRIBUTE add constraint FK22C9DB75604DBDA8 foreign key (EXECUTION_ID) references EXECUTION;drop table COMMONS_GRAPH;
drop table COMMONS_GRAPH_EDGE;
drop table COMMONS_GRAPH_TO_EDGES;
drop table COMMONS_GRAPH_TO_VERTICES;
drop table QUERY;
...
create table COMMONS_GRAPH_TO_VERTICES (GRAPH_ID bigint not null, VERTEX_CLASS varchar(255), VERTEX_ID bigint);
create table QUERY (IDENTIFIER bigint not null, CONSTRAINTS_ID bigint, primary key (IDENTIFIER));
create table QUERY_ABSTRACT_QUERY (IDENTIFIER bigint generated by default as identity, QUERY_NAME varchar(4096), QUERY_TYPE varchar(30), DESCRIPTION varchar(1024), CREATED_DATE timestamp not null, CREATED_BY bigint not null, UPDATION_DATE timestamp not null, UPDATED_BY bigint not null, primary key (IDENTIFIER));
create table QUERY_ARITHMETIC_OPERAND (IDENTIFIER bigint not null, LITERAL varchar(255), TERM_TYPE varchar(255), DATE_LITERAL date, TIME_INTERVAL varchar(255), DE_ATTRIBUTE_ID bigint, EXPRESSION_ID bigint, primary key (IDENTIFIER));
create table QUERY_BASEEXPR_TO_CONNECTORS (BASE_EXPRESSION_ID bigint not null, CONNECTOR_ID bigint not null, POSITION integer not null, primary key (BASE_EXPRESSION_ID, POSITION));
create table QUERY_BASE_EXPRESSION (IDENTIFIER bigint generated by default as identity, EXPR_TYPE varchar(255) not null, primary key (IDENTIFIER));
create table QUERY_BASE_EXPR_OPND (BASE_EXPRESSION_ID bigint not null, OPERAND_ID bigint not null, POSITION integer not null, primary key (BASE_EXPRESSION_ID, POSITION));
...
create table QUERY_OPERAND (IDENTIFIER bigint generated by default as identity, OPND_TYPE varchar(255) not null, primary key (IDENTIFIER));
create table QUERY_OPERATION (IDENTIFIER bigint generated by default as identity, OPERAND_ONE bigint, OPERAND_TWO bigint, primary key (IDENTIFIER));
create table QUERY_OUTPUT_ATTRIBUTE (IDENTIFIER bigint generated by default as identity, NAME varchar(255), EXPRESSION_ID bigint, ATTRIBUTE_ID bigint not null, PARAMETERIZED_QUERY_ID bigint, POSITION integer, DATA_VIEW_ID bigint, primary key (IDENTIFIER));
create table QUERY_OUTPUT_TERM (IDENTIFIER bigint generated by default as identity, NAME varchar(255), TIME_INTERVAL varchar(255), TERM_ID bigint, primary key (IDENTIFIER));
create table QUERY_PARAMETER (IDENTIFIER bigint generated by default as identity, NAME varchar(255), OBJECT_CLASS varchar(255), OBJECT_ID bigint, primary key (IDENTIFIER));
create table QUERY_PARAMETERIZED_QUERY (IDENTIFIER bigint not null, primary key (IDENTIFIER));
create table QUERY_QUERY_ENTITY (IDENTIFIER bigint generated by default as identity, ENTITY_ID bigint not null, primary key (IDENTIFIER));
...
create table QUERY_TO_OUTPUT_TERMS (QUERY_ID bigint not null, OUTPUT_TERM_ID bigint not null unique, POSITION integer not null, primary key (QUERY_ID, POSITION));
create table QUERY_TO_PARAMETERS (QUERY_ID bigint not null, PARAMETER_ID bigint not null unique, POSITION integer not null, primary key (QUERY_ID, POSITION));
create table QUERY_WORKFLOW (IDENTIFIER bigint not null generated by default as identity, USER_ID bigint, WORKFLOW_NAME varchar(1024), CREATED_ON timestamp not null, WORKFLOW_DESCRIPTION varchar(1024), primary key (IDENTIFIER));
create table QUERY_WORKFLOW_ITEM (IDENTIFIER bigint not null generated by default as identity, QUERY_ID bigint, WORKFLOW_ID bigint, POSITION integer, primary key (IDENTIFIER));
create table QUERY_UNION (IDENTIFIER bigint not null, primary key (IDENTIFIER));
alter table COMMONS_GRAPH_TO_EDGES add constraint FKA6B0D8BAA0494B1D foreign key (GRAPH_ID) references COMMONS_GRAPH;
alter table COMMONS_GRAPH_TO_EDGES add constraint FKA6B0D8BAFAEF80D foreign key (EDGE_ID) references COMMONS_GRAPH_EDGE;
...
alter table EXECUTION_TO_OUTPUT_ATTRIBUTE add constraint FK22C9DB75E92C8D41 foreign key (EXPRESSION_ID) references QUERY_BASE_EXPRESSION;
alter table EXECUTION_TO_OUTPUT_ATTRIBUTE add constraint FK22C9DB75F961B22E foreign key (DATA_VIEW_ID) references QUERY_DATA_VIEW;
alter table EXECUTION_TO_OUTPUT_ATTRIBUTE add constraint FK22C9DB75604DBDA8 foreign key (EXECUTION_ID) references EXECUTION;
