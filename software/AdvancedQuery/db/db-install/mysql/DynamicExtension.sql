...
create table ABSTRACT_CATEGORY (ID bigint not null not null auto_increment, PARENT_CATEGORY_ID bigint unique, primary key (ID));
...
create table DE_COLL_ATTR_RECORD_VALUES (IDENTIFIER bigint not null auto_increment, RECORD_VALUE varchar(4000), COLLECTION_ATTR_RECORD_ID bigint, primary key (IDENTIFIER));
create table DE_FILE_ATTR_RECORD_VALUES (IDENTIFIER bigint not null auto_increment, CONTENT_TYPE varchar(255), FILE_CONTENT blob(255), FILE_NAME varchar(255), RECORD_ID bigint, primary key (IDENTIFIER));
create table DE_OBJECT_ATTR_RECORD_VALUES (IDENTIFIER bigint not null auto_increment, CLASS_NAME varchar(255), OBJECT_CONTENT blob(255), RECORD_ID bigint, primary key (IDENTIFIER));
create table DYEXTN_ABSTRACT_ENTITY (id bigint not null, primary key (id));
create table DYEXTN_ABSTRACT_METADATA (IDENTIFIER bigint not null auto_increment, CREATED_DATE date, DESCRIPTION varchar(1000), LAST_UPDATED date, NAME varchar(1000), PUBLIC_ID varchar(255), primary key (IDENTIFIER));
...
create table DYEXTN_CONTAINER (IDENTIFIER bigint not null auto_increment, BUTTON_CSS varchar(255), CAPTION varchar(800), ABSTRACT_ENTITY_ID bigint, MAIN_TABLE_CSS varchar(255), REQUIRED_FIELD_INDICATOR varchar(255), REQUIRED_FIELD_WARNING_MESSAGE varchar(255), TITLE_CSS varchar(255), BASE_CONTAINER_ID bigint, ADD_CAPTION smallint, ENTITY_GROUP_ID bigint, VIEW_ID bigint, primary key (IDENTIFIER));
create table DYEXTN_CONTAINMENT_CONTROL (IDENTIFIER bigint not null, primary key (IDENTIFIER));
create table DYEXTN_CONTROL (IDENTIFIER bigint not null auto_increment, CAPTION varchar(800), CSS_CLASS varchar(255), HIDDEN smallint, NAME varchar(255), SEQUENCE_NUMBER integer, TOOLTIP varchar(255), CONTAINER_ID bigint, BASE_ABST_ATR_ID bigint, READ_ONLY smallint, HEADING varchar(255), primary key (IDENTIFIER));
...
create table DYEXTN_FORM_CONTEXT (IDENTIFIER bigint not null auto_increment, IS_INFINITE_ENTRY smallint, ENTITY_MAP_ID bigint, STUDY_FORM_LABEL varchar(255), NO_OF_ENTRIES integer, primary key (IDENTIFIER));
...
create table DYEXTN_RULE (IDENTIFIER bigint not null auto_increment, NAME varchar(255), IS_IMPLICIT smallint, ATTRIBUTE_ID bigint, CATEGORY_ATTR_ID bigint, primary key (IDENTIFIER));
...
create table DYEXTN_SQL_AUDIT (IDENTIFIER bigint not null auto_increment, AUDIT_DATE timestamp, QUERY_EXECUTED varchar(4000), USER_ID bigint, primary key (IDENTIFIER));
