...
create table QUERY_PARAMETERIZED_QUERY (IDENTIFIER number(19,0) not null, QUERY_NAME varchar2(255 char) not null unique, SHOW_TREE number(1,0) not null,DESCRIPTION varchar2(1024 char), primary key (IDENTIFIER));
