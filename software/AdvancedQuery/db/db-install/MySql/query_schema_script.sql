...
create table QUERY (IDENTIFIER bigint not null auto_increment, CONSTRAINTS_ID bigint unique,IS_NORMALIZED_VIEW BOOLEAN default false, primary key (IDENTIFIER));
...
create table QUERY_PARAMETERIZED_QUERY (IDENTIFIER bigint not null, QUERY_NAME varchar(255) not null unique, SHOW_TREE tinyint(1) not null,DESCRIPTION text, primary key (IDENTIFIER));
