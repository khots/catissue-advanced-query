...
function doInItTreeGrid()
{
	...
	mygrid.imgURL = "deploytempCatissuecore/AdvanceQuery/dhtml/imgs/";
...
{
	mygrid.loadXML("TreeGridInItAction.do?entityTag="+entityTag);
...
function ajaxTagDeleteCall(tagId,msg) {
 var childCount=mygrid.hasChildren(tagId);
 ...
 function getJsonObj()
 {
	 if (xmlHttpobj.readyState == 4) 
	 {
		 ...
		 var count;
 		 ...
 		 childCount=mygrid.hasChildren(tagID);
	 if(childCount==0)
		{
...
mygrid.addRow((new Date()).valueOf(),[,arrObj.treeData[count].name,"<img src='images/advQuery/delete.gif' width='12' height='12' id='tagItemId' onclick='ajaxObjDeleteCall("+tagItemId+")'/>"],(new Date()).valueOf(),tagID);
	pause(10);
 			}
		}
...
mygrid.addRow((new Date()).valueOf(),[,arrObj.treeData[count].name,"<img src='images/advQuery/delete.gif' width='12' height='12' id='tagItemId' onclick='ajaxObjDeleteCall('"+tagItemId+"','"+popupFolderDeleteMessage+"')'/>"],0,tagID);
 	pause(10);			}
		}
