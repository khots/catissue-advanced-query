...
function showHide(elementid)
{
	...
	if (document.getElementById(elementid).style.display == 'none'){
		...
		switchImg.innerHTML = '<img src="images/advQuery/uIEnhancementImages/up_arrow.gif" alt="Hide Details" border="0" width="80" height="9" hspace="10" vspace="3 "/>';
							
	} else {
		document.getElementById(elementid).style.display = 'none';
		switchImg.innerHTML = '<img src="images/advQuery/uIEnhancementImages/dwn_arrow1.gif" alt="Show Details" border="0" width="80" height="9" hspace="10" vspace="3"/>';
