...
<script language="JavaScript" type="text/javascript"
	src="jss/advQuery/scwcalendar.js"></script>
</head>
<%
	String[] attributeConditionArray = (String[]) request
	.getAttribute(AQConstants);
...
function showDateColumn(element,valueField,columnID,showCalendarID,fieldValue,overDiv)
{
	...
	else
	{
		...
		if (dataType == "<%=AQConstants.FIELD_TYPE_DATE%>" || dataType == "<%=AQConstants.FIELD_TYPE_TIMESTAMP_DATE%>")
		{
...
function onAttributeChange(element,opComboName,txtFieldID)
{
	...
	if(element.value == "<%=AQConstants.SELECT_OPTION%>")
	{
		opCombo.options[0] = new Option("<%=AQConstants.SELECT_OPTION%>","-1");
	}
	else
	{
		...
		else if (columnValue.match("<%=AQConstants%>") == "<%=AQConstants%>")
		{
...
<html:form action="<%=AQConstants%>">
		<html:hidden property="aliasName" value="<%=aliasName%>" />
		<html:hidden property="<%=AQConstants%>"
			value="<%=selectMenu%>" />
  ...
  <tr>
    <td class="td_color_bfdcf3"><table border="0" cellpadding="0" cellspacing="0">
      ...
      %> 	   
		...
		<td align="right"><img src="images/advQuery/uIEnhancementImages/table_title_corner2.gif" alt="<%=pageTitle%>"  width="31" height="24" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td class="tablepadding"><table width="100%" border="0" cellpadding="0" cellspacing="0">
	<logic:notEqual name="pageOf" value="<%=AQConstants.PAGEOF_SIMPLE_QUERY_INTERFACE%>">
	<tr>
	<td class="td_tab_bg" ><img src="images/advQuery/uIEnhancementImages/spacer.gif" alt="spacer" width="50" height="1"></td>
	<!----Add tab hidden for the Specimen Search----->
		<logic:notEqual name="pageOf" value="<%=AQConstants%>">
        <td valign="bottom"><html:link href="#" onclick="callSerachAction('CommonTab.do')">
		<img src="images/advQuery/uIEnhancementImages/tab_add_notSelected.jpg" alt="Add" width="57" height="22" /></html:link></td>
		</logic:notEqual>
       
		<td valign="bottom"><img src="images/advQuery/uIEnhancementImages/tab_edit_selected.jpg" alt="Edit" width="59" height="22" border="0" /></td>
		<logic:equal name="pageOf" value="<%=AQConstants%>">
        <td valign="bottom"><html:link page="/ApproveUserShow.do?pageNum=1"><img src="images/advQuery/uIEnhancementImages/tab_approve_user.jpg" alt="Approve New Users" width="139" height="22" border="0" /></html:link></td>
		</logic:equal>
		<logic:equal name="pageOf" value="pageOfStorageContainer">
		<td  valign="bottom"><a href="#"><img src="images/advQuery/uIEnhancementImages/view_map2.gif" alt="View Map"width="76" height="22" border="0" onclick="vieMapTabSelected()"/></a></td>
		</logic:equal>
<!-- These tabs are visible in case of specimen page--->
		 <logic:equal name="pageOf" value="<%=AQConstants%>">
			<td valign="bottom"><html:link page="/CreateSpecimen.do?operation=add&amp;pageOf=&virtualLocated=true">	<img src="images/advQuery/uIEnhancementImages/tab_derive2.gif" alt="Derive" width="56" height="22" border="0"/>	</html:link></td>
			<td valign="bottom"><html:link page="/Aliquots.do?pageOf=pageOfAliquot"><img src="images/advQuery/uIEnhancementImages/tab_aliquot2.gif" alt="Aliquot" width="66" height="22" border="0" >		</html:link></td>
			<td valign="bottom"><html:link page="/QuickEvents.do?operation=add"><img src="images/advQuery/uIEnhancementImages/tab_events2.gif" alt="Events" width="56" height="22" border="0" />		</html:link></td>
			<td valign="bottom"><html:link page="/MultipleSpecimenFlexInitAction.do?pageOf=pageOfMultipleSpWithMenu"><img src="images/advQuery/uIEnhancementImages/tab_multiple2.gif" alt="Multiple" width="66" height="22" border="0" />	</html:link></td>
		</logic:equal>
	...
	<logic:equal name="pageOf" value="<%=AQConstants.PAGEOF_SIMPLE_QUERY_INTERFACE%>">
      ...
      <tr>
        <td colspan="2" align="left" class="bottomtd"><%@ include file="/pages/advQuery/content/common/ActionErrors.jsp" %></td>
      </tr>
      <tr>
	 ...
	 %>
      <tr>
        <td align="right"><table width="100%" border="0" cellspacing="0" cellpadding="2">
            <tr>
              <td width="94%" align="right" nowrap><img src="images/advQuery/uIEnhancementImages/viewall_icon.gif" alt="View All" /></td>
			...
			<logic:equal name="pageOf" value="<%=AQConstants.PAGEOF_SIMPLE_QUERY_INTERFACE%>">
              ...
              <td nowrap class="black_new">
								<html:select property="<%=attributeCondition%>"
											...
											<%
												} else if (attributeType.equals(AQConstants.FIELD_TYPE_DATE)
																							|| attributeType
																							.equals(AQConstants.FIELD_TYPE_TIMESTAMP_DATE)) {
											%>
											<html:option value="<%=Operator.EQUAL%>">Equals</html:option>
											<html:option value="<%=Operator.NOT_EQUALS%>">Not Equals</html:option>
											<html:option value="<%=Operator.LESS_THAN%>">
