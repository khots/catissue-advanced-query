...
public class AQConstants
{
	...
	public static final String EDIT_LIMITS = "<li><font color='blue'>Limit successfully edited.</font></li>";
	...
	//Constants for TQ
	public static final String HASH_OUT = "##";
	public static final String PHI_AGE = "90+ Years";

	//Constants required for csm purpose
	...
	public static final String QUERY_FOR_COLLECTION_PROTOCOL = "mainProtocolObject.caTissue.query";
	public static final String  QUERY_FOR_CLINICAL_STUDY = "mainProtocolObject.clinportal.query";

	//constants required for API query filtering
	...
	public static final String SHARED_QUERIES = "sharedQueries";
	public static final String AUDIT_EVENT_ID = "AUDIT_EVENT_ID";
	public static final String TEMP_TABLE_NAME = "TEMP_TABLE_NAME";
	public static final String IF_TEMP_TABLE_DELETED = "IS_TEMP_TABLE_DELETED";
	public static final String ROOT_ENTITY_NAME = "ROOT_ENTITY_NAME";
	public static final String COUNT_OF_ROOT_RECORDS = "COUNT_OF_ROOT_RECORDS";
	...
	public static final String QUERYS_ID = "queryId";
	...
	public static final String getOracleTermString(String string)
	{
		return "extract(day from " + string + ")*86400 + extract(hour from " + string
		+ ")*3600 + extract(minute from " + string + ")*60 + extract(second from " + string
		+ ")";
	}
	...
	public static final String EDIT_LOWER_CASE = "edit";
	...
	public static final String IS_MY_QUERY = "isMyQuery";
	public static final String QUERY_ID = "QUERY_ID";

	public static final String CONDITION_SEPERATOR = "!*=*!";
	public static final String ID_CONDITION = "@#condition#@id";
	...
	//Constants related to html tags.
	public static final String END_TD = "</td>";

	public static final String MAIN_PROTOCOL_QUERY = "mainProtocol.sql";

	public static final String DASHBOARD_ERROR = "Error in checking privileges on query for dashboard";

	//Constants copied from AQConstants.java
	public static final int ARGUMENT_ZERO = 0;
	public static final int INDEX_PARAM_ZERO = 0;
	public static final int INDEX_PARAM_ONE = 1;
	public static final int INDEX_PARAM_TWO = 2;
	public static final int INDEX_PARAM_THREE = 3;
