...
{
	SUCCESS(0), EMPTY_DAG(1), MULTIPLE_ROOT(2), NO_RESULT_PRESENT(3), SQL_EXCEPTION(4), DAO_EXCEPTION(
			5), CLASS_NOT_FOUND(6), RESULTS_MORE_THAN_LIMIT(10), NO_MAIN_OBJECT_IN_QUERY(11),GENERIC_EXCEPTION(12)
			,INVALID_METADATA(13);
