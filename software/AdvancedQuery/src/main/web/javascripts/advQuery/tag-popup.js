...
function ajaxPopupFunctionCall(msg,msg1) {
queryDeleteMsg=msg;
...
if (window.XMLHttpRequest)
  ...
  xmlHttpobj=new ActiveXObject("Microsoft.XMLHTTP");
	...
	var queryCheckBoxAr = document.getElementsByName("queryCheckbox");
...
mygrid.addRow((new Date()).valueOf(),[,arrObj.treeData[count].name,"<img src='images/advQuery/delete.gif' width='12' height='12' id='assignId' onclick='ajaxObjDeleteCall("+assignId+")'/>"],(new Date()).valueOf(),tagID);
	pause(10);
 			}
		}
...
mygrid.addRow((new Date()).valueOf(),[,arrObj.treeData[count].name,"<img src='images/advQuery/delete.gif' width='12' height='12' id='assignId' onclick='ajaxObjDeleteCall('"+assignId+"','"+popupFolderDeleteMessage+"')'/>"],0,tagID);
 	pause(10);			}
		}
