...
<%@ page import="edu.wustl.common.queryFolder.beans.Tag"%>
...
<link rel="STYLESHEET" type="text/css"
	href="jss/advQuery/dhtml_comp/css/dhtmlXTree.css">
<script src="jss/advQuery/dhtml_comp/js/dhtmlXCommon.js"></script>
<link rel="STYLESHEET" type="text/css"
	href="jss/advQuery/dhtml_comp/css/dhtmlXGrid.css" />
<link rel="STYLESHEET" type="text/css"
	href="jss/advQuery/dhtml_comp/css/dhtmlxgrid_dhx_skyblue.css" />
<script src="jss/advQuery/dhtml_comp/js/dhtmlx.js"></script>
<script src="jss/advQuery/dhtml_comp/js/dhtmlXTree.js"></script>
<script src="jss/advQuery/dhtml_comp/js/dhtmlXTreeCommon.js"></script>
<script src="jss/advQuery/dhtml_comp/js/dhtmlXGridCell.js"></script>
<script src="jss/advQuery/dhtml_comp/js/dhtmlXTreeGrid.js"></script>
<script>
...
function doInitGrid()
{
	...
	grid.setImagePath("jss/advQuery/dhtml_comp/imgs/");
...
function doInItTreeGrid()
{
	...
	mygrid.imgURL = "jss/advQuery/dhtml_comp/imgs/";
	mygrid.setHeader(",<div style='text-align:center;'>My Folders</div>,");
	//mygrid.setNoHeader(true);
	mygrid.setInitWidths("25,*,40");
	mygrid.setColAlign("left,left,left");
	mygrid.setColTypes("txt,tree,txt");
	mygrid.setColSorting("str,str,str");
	mygrid.attachEvent("onRowSelect", doOnTreeGridRowSelected);
...
{
	mygrid.loadXML("TreeTagAction.do");
		...
		<table width='100%' cellpadding='0' cellspacing='0' border='0'
			...
			<tr>
				...
				<td>
					<div>
						<%
 						String	organizeTarget = "ajaxPopupFunctionCall('"+popupDeleteMessage+"','"+popupFolderDeleteMessage+"')";
 %>
		...
		<div id="left">
			<table class="tags" width="100%" cellspacing="0" cellpadding="1"
				border="0">
					...
					<tr>
						<td><div style="height: 30px; width: 166px;" id="toolbarObj1">
								<input type="button" value="My Queries"
									onclick="submitTheForm('RetrieveQueryAction.do?pageOf=myQueries',this);"
									class="btn1">
							</div>
						</td>
					</tr>
					<tr>
						<td><div style="height: 30px; width: 166px;" id="toolbarObj2">
								<input type="button" value="All Queries"
									onclick="submitTheForm('RetrieveQueryAction.do?pageOf=allQueries',this);"
									class="btn1">
							</div>
						</td>
					</tr>
					<tr>
						<td><div style="height: 30px; width: 166px;" id="toolbarObj3">
								<input type="button" value="Shared Queries"
									onclick="submitTheForm('RetrieveQueryAction.do?pageOf=sharedQueries',this);"
									class="btn1">
							</div>
						</td>
					</tr>
										...
										<div id="tableDiv">
											<tr class="<%=cssClass%>">
												...
												<td valign="center" height='20' width="31%" align="left"><input
													type="checkbox" name="queryCheckbox"
