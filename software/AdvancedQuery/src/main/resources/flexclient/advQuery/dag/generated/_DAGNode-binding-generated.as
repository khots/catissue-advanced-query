...
class BindableProperty
{
	...
	/**
	 * generated bindable wrapper for property _VBox2 (public)
	 * - generated setter
	 * - generated getter
	 * - original public var '_VBox2' moved to '_1493698498_VBox2'
	 */

    [Bindable(event="propertyChange")]
    public function get _VBox2():mx.containers.VBox
    {
        return this._1493698498_VBox2;
    }

    public function set _VBox2(value:mx.containers.VBox):void
    {
    	var oldValue:Object = this._1493698498_VBox2;
        if (oldValue !== value)
        {
			this._1493698498_VBox2 = value;
            dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "_VBox2", oldValue, value));
        }
    }
	...
	/**
	 * generated bindable wrapper for property createMenu (public)
	 * - generated setter
	 * - generated getter
	 * - original public var 'createMenu' moved to '_1369001083createMenu'
	 */

    [Bindable(event="propertyChange")]
    public function get createMenu():mx.controls.Button
    {
        return this._1369001083createMenu;
    }

    public function set createMenu(value:mx.controls.Button):void
    {
    	var oldValue:Object = this._1369001083createMenu;
        if (oldValue !== value)
        {
			this._1369001083createMenu = value;
            dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "createMenu", oldValue, value));
        }
    }

	/**
	 * generated bindable wrapper for property nodeNo (public)
	 * - generated setter
	 * - generated getter
	 * - original public var 'nodeNo' moved to '_1040171165nodeNo'
	 */

    [Bindable(event="propertyChange")]
    public function get nodeNo():mx.controls.Label
    {
        return this._1040171165nodeNo;
    }

    public function set nodeNo(value:mx.controls.Label):void
    {
    	var oldValue:Object = this._1040171165nodeNo;
        if (oldValue !== value)
        {
			this._1040171165nodeNo = value;
            dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "nodeNo", oldValue, value));
        }
    }
	...
	/**
	 * generated bindable wrapper for property displayoutAssociations (public)
	 * - generated setter
	 * - generated getter
	 * - original public var 'displayoutAssociations' moved to '_2029044354displayoutAssociations'
	 */

    [Bindable(event="propertyChange")]
    public function get displayoutAssociations():ArrayCollection
    {
        return this._2029044354displayoutAssociations;
    }

    public function set displayoutAssociations(value:ArrayCollection):void
    {
    	var oldValue:Object = this._2029044354displayoutAssociations;
        if (oldValue !== value)
        {
			this._2029044354displayoutAssociations = value;
            dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "displayoutAssociations", oldValue, value));
        }
    }
