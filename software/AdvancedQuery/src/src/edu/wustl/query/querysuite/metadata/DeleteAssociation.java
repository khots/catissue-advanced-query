...
////				.createStatement());
//
//		int SOURCE_ENTITY_ID = UpdateMetadataUtil.getEntityIdByName(srcName, jdbcdao);
//		int TARGET_ENTITY_ID = UpdateMetadataUtil.getEntityIdByName(targetName, jdbcdao);
//
...
//			int TARGET_ENTITY_ID) throws SQLException, DAOException
//	{
//		String sql;
//		Long srcRoleId = null;
...
//						ResultSet rs3 =jdbcdao.getQueryResultSet(sql);
//						if (rs3.next())
//						{
...
//	}
//
//	private void updateEntityToDeleteList() throws SQLException, DAOException
//	{
//		String sql;
//		//stmt = connection.createStatement();
//		ResultSet rs;
...
////	}
//	public DeleteAssociation(JDBCDAO jdbcdao) throws SQLException
//	{
//		super();
