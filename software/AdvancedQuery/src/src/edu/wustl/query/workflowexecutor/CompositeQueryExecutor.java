...
public class CompositeQueryExecutor
{
	...
	private List<Long> queryExecIdList;
...
//	private final String sql;
	 ...
	 *            separate query.
	 */
	public CompositeQueryExecutor(AbstractQuery ciderQuery, List<Long> queryExecIdList)//, String sql)
	{
...
//	}
	 ...
	 * @param queryexecId
	 */
//	public void cancel(Long queryExecId) throws QueryModuleException
//	{
//		try
//		{
...
//		try
//		{
//			Iterator<Long> queryExecIdListIter = queryExecIdList.iterator();
//			Count count = null;
//
...
//	}
	 ...
	 */
	public Long executeQuery() throws MultipleRootsException, SqlException, QueryModuleException
	{
