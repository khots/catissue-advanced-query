 ...
 *	Package:	
 *	Class: 		DAG
 *	Source: 	E:\workplace\AdvancedQueryForJoin_NewCP\flexclient\advQuery\dag\DAG.mxml
 *	Template: 	flex2/compiler/mxml/gen/ClassDef.vm
 *	Time: 		2009.04.07 12:38:48 GMT+05:30
 */
...
new mx.core.UIComponentDescriptor({
  ...
  propertiesFactory: function():Object { return {
                    ...
                    propertiesFactory: function():Object { return {
                      ...
                      ,
                        new mx.core.UIComponentDescriptor({
                          ...
                          propertiesFactory: function():Object { return {
                            label: "Join Query",
                            toolTip: "Create Join query on selected nodes"
                          }}
                        })
                      ]
                    }}
	...
	public function DAG()
	{
		...
		this.addEventListener("resize", ___Application1_resize);
...
private function _RemoteObject1_i() : mx.rpc.remoting.mxml.RemoteObject
{
	...
	rpcService = temp;
	temp.destination = "queryService";
	temp.operations = {};
	temp.addEventListener("fault", __rpcService_fault);
 ...
 * @private
 **/
public function __rpcService_fault(event:mx.rpc.events.FaultEvent):void
{
	faultHandler(event);
}
 ...
 * @private
 **/
public function ___Application1_resize(event:mx.events.ResizeEvent):void
{
	onStageResize()
}
 ...
 * @private
 **/
public function __JoinQueryBtn_click(event:flash.events.MouseEvent):void
{
	openJoinQueryPopUp()
}
