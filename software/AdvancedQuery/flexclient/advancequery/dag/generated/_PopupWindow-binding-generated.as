...
class BindableProperty
{
	...
	/**
	 * generated bindable wrapper for property myDropdownFactory (private)
	 * - generated setter
	 * - generated getter
	 * - original private var 'myDropdownFactory' moved to '_138666899myDropdownFactory'
	 */

    [Bindable(event="propertyChange")]
    private function get myDropdownFactory():ClassFactory
    {
        return this._138666899myDropdownFactory;
    }

    private function set myDropdownFactory(value:ClassFactory):void
    {
    	var oldValue:Object = this._138666899myDropdownFactory;
        if (oldValue !== value)
        {
			this._138666899myDropdownFactory = value;
            dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "myDropdownFactory", oldValue, value));
        }
    }
