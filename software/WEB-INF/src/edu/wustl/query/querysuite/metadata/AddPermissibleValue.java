...
//
//	public List<String> addPermissibleValue() throws SQLException, IOException, DAOException
//	{
...
//
//		sql = "insert into dyextn_data_element values (" + dataElementId + ","
...
//				value = "'" + (String) value + "'";
//			}
//			sql = "insert into dyextn_permissible_value values (" + permissibleValueId + ",null,"
//					+ attribute.getAttributeTypeInformation().getDataElement().getId() + ",null)";
//			//UpdateMetadataUtil.executeInsertSQL(sql, connection.createStatement());
//			UpdateMetadataUtil.executeInsertSQL(sql,jdbcdao);
//			
...
//		entityAttributesToAdd.put("edu.wustl.catissuecore.domain.AbstractSpecimen",
//				attributeToDelete);
//	}
//
...
////	}
//	public AddPermissibleValue(JDBCDAO jdbcdao) throws SQLException
//	{
//		super();
