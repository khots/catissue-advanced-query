...
//
//	public List<String> deletePermissibleValue() throws SQLException, DAOException
//	{
...
////		entityIDAttributeListMap = UpdateMetadataUtil.populateEntityAttributeMap(connection,
////				entityIDMap);
//		entityIDAttributeListMap = UpdateMetadataUtil.populateEntityAttributeMap(jdbcdao,
//				entityIDMap);
...
//		{
//			sql = "delete from dyextn_long_concept_value where IDENTIFIER in (select PERMISSIBLE_VALUE_ID from dyextn_userdef_de_value_rel where USER_DEF_DE_ID in (select identifier from dyextn_userdefined_de where  identifier in (select identifier from dyextn_data_element where ATTRIBUTE_TYPE_INFO_ID="
...
//		{
//			sql = "delete from  dyextn_string_concept_value where IDENTIFIER in (select PERMISSIBLE_VALUE_ID from dyextn_userdef_de_value_rel where USER_DEF_DE_ID in (select identifier from dyextn_userdefined_de where  identifier in (select identifier from dyextn_data_element where ATTRIBUTE_TYPE_INFO_ID="
//					+ attribute.getAttributeTypeInformation().getDataElement().getId() + ")))";
//			deleteSQL.add(sql);
//
...
//		{
//			sql = "delete from  dyextn_integer_concept_value where IDENTIFIER in (select PERMISSIBLE_VALUE_ID from dyextn_userdef_de_value_rel where USER_DEF_DE_ID in (select identifier from dyextn_userdefined_de where  identifier in (select identifier from dyextn_data_element where ATTRIBUTE_TYPE_INFO_ID="
//					+ attribute.getAttributeTypeInformation().getDataElement().getId() + ")))";
//			deleteSQL.add(sql);
//
...
//		{
//			sql = "delete from  dyextn_double_concept_value where IDENTIFIER in (select PERMISSIBLE_VALUE_ID from dyextn_userdef_de_value_rel where USER_DEF_DE_ID in (select identifier from dyextn_userdefined_de where  identifier in (select identifier from dyextn_data_element where ATTRIBUTE_TYPE_INFO_ID="
//					+ attribute.getAttributeTypeInformation().getDataElement().getId() + ")))";
//			deleteSQL.add(sql);
//
...
//		{
//			sql = "delete from  dyextn_boolean_concept_value where IDENTIFIER in (select PERMISSIBLE_VALUE_ID from dyextn_userdef_de_value_rel where USER_DEF_DE_ID in (select identifier from dyextn_userdefined_de where  identifier in (select identifier from dyextn_data_element where ATTRIBUTE_TYPE_INFO_ID="
//					+ attribute.getAttributeTypeInformation().getDataElement().getId() + ")))";
//			deleteSQL.add(sql);
//
...
//		}
//
//		sql = "delete from dyextn_userdef_de_value_rel where USER_DEF_DE_ID in (select identifier from dyextn_userdefined_de where  identifier in (select identifier from dyextn_data_element where ATTRIBUTE_TYPE_INFO_ID="
//				+ attribute.getAttributeTypeInformation().getDataElement().getId() + "))";
//		deleteSQL.add(sql);
//
//		sql = "delete from dyextn_userdefined_de where  identifier in (select identifier from dyextn_data_element where ATTRIBUTE_TYPE_INFO_ID="
//				+ attribute.getAttributeTypeInformation().getDataElement().getId() + ")";
//		deleteSQL.add(sql);
//
...
//		entityAttributesToDelete.put("edu.wustl.catissuecore.domain.CellSpecimen",
//				attributeToDelete);
//		entityAttributesToDelete.put("edu.wustl.catissuecore.domain.FluidSpecimen",
//				attributeToDelete);
//		entityAttributesToDelete.put("edu.wustl.catissuecore.domain.MolecularSpecimen",
//				attributeToDelete);
//		entityAttributesToDelete.put("edu.wustl.catissuecore.domain.TissueSpecimen",
//				attributeToDelete);
//
...
//	}
//
//	private void populateEntityIDList() throws SQLException, DAOException
//	{
//		String sql;
...
////		return rs;
////	}
//	private ResultSet executeQuery(String sql) throws SQLException, DAOException
//	{
//		
...
////	}
//	public DeletePermissibleValueAttribute(JDBCDAO jdbcdao) throws SQLException
//	{
