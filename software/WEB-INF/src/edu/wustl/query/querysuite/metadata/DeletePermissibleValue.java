...
//		{
//			sql = "select * from dyextn_string_concept_value where IDENTIFIER in (select PERMISSIBLE_VALUE_ID from dyextn_userdef_de_value_rel where USER_DEF_DE_ID in (select identifier from dyextn_userdefined_de where  identifier in (select identifier from dyextn_data_element where ATTRIBUTE_TYPE_INFO_ID="
...
//	{
//		if (permissibleValueToDeleteList.contains(name)
//				&& numberOfOccurenceToDeleteMap.get(name + "_" + string) != null
//				&& numberOfOccurenceToDeleteMap.get(name + "_" + string) > 0)
//		{
...
//		numberOfOccurenceToDeleteMap.put(
...
//		numberOfOccurenceToDeleteMap
//				.put(
//						"tissueSite_OTHER AND ILL-DEFINED SITES WITHIN RESPIRATORY SYSTEM AND INTRATHORACIC ORGANS",
//						1);
//		numberOfOccurenceToDeleteMap.put("tissueSite_OTHER AND UNSPECIFIED FEMALE GENITAL ORGANS",
//				1);
//		numberOfOccurenceToDeleteMap.put("tissueSite_OTHER AND UNSPECIFIED MAJOR SALIVARY GLANDS",
//				1);
//		numberOfOccurenceToDeleteMap.put("tissueSite_OTHER AND UNSPECIFIED MALE GENITAL ORGANS", 1);
//		numberOfOccurenceToDeleteMap.put("tissueSite_OTHER AND UNSPECIFIED PARTS OF BILIARY TRACT",
//				1);
...
//		numberOfOccurenceToDeleteMap.put("tissueSite_RESPIRATORY SYSTEM AND INTRATHORACIC ORGANS",
//				1);
...
//		numberOfOccurenceToDeleteMap
//				.put(
//						"tissueSite_SPINAL CORD, CRANIAL NERVES, AND OTHER PARTS OF CENTRAL NERVOUS SYSTEM",
//						1);
...
//
//		DeletePermissibleValue deletePermissibleValue = new DeletePermissibleValue(jdbcdao);
...
//		entityAttributesToDelete.put("edu.wustl.catissuecore.domain.SpecimenCharacteristics",
//				attributeToDelete);
//
//		attributeToDelete = new ArrayList<String>();
//		attributeToDelete.add("specimenType");
//		entityAttributesToDelete.put("edu.wustl.catissuecore.domain.AbstractSpecimen",
//				attributeToDelete);
//	}
//
...
////	}
//	public DeletePermissibleValue(JDBCDAO jdbcdao) throws SQLException
//	{
