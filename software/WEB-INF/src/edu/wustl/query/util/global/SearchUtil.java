...
//		operatorList.add(new NameValueBean(edu.wustl.common.util.global.Constants.ANY, 
//				edu.wustl.common.util.global.Constants.ANY));
//
//		switch (dataType)
//		{
//			case DATATYPE_DATE :
...
//		newTableList.add(new NameValueBean(edu.wustl.common.util.global.Constants.SELECT_OPTION, "-1"));
//
