...
// * 
// */
//public class SqlGenerator extends AbstractQueryGenerator
//{
//
//	private static String strTodateFunction = "";
//	private static String datepattern = "";
//	private static org.apache.log4j.Logger logger = LoggerConfig
//			.getConfiguredLogger(SqlGenerator.class);
//
//	/**
...
//	{
//		logger.debug("Srarted SqlGenerator.generateSQL().....");
//		String sql;
//		try
//		{
...
//					e, QueryModuleError.MULTIPLE_ROOT);
//		}
//		catch (SqlException e)
//		{
//			throw new QueryModuleException("problem while trying to build xquery" + e.getMessage(),
//					e, QueryModuleError.SQL_EXCEPTION);
//		}
//		logger.debug("Finished SqlGenerator.generateSQL()...SQL:" + sql);
//		return sql;
//	}
//
//	/**
...
//		catch (IOException e)
//		{
//			logger.error("Error while logging sql.\n" + e);
//		}
//	}
//
//	/**
...
//	 * @return
//	 */
//	private ICondition createActivityStatusCondition(QueryableAttributeInterface attributeObj)
//	{
//		List<String> values = new ArrayList<String>();
//		values.add(Status.ACTIVITY_STATUS_DISABLED.toString());
//		ICondition condition = QueryObjectFactory.createCondition(attributeObj,
...
//			try
//			{
//				//				QueryableObjectInterface rootDEEntity = constraints.getRootExpression().getQueryEntity()
//				//						.getDynamicExtensionsEntity();
//				//boolean isCategory = edu.wustl.cab2b.common.util.Utility.isCategory(rootDEEntity.getEntity());
//
...
//		{
//			QueryableObjectInterface leftEntity = expression.getQueryEntity()
//					.getDynamicExtensionsEntity();
...
//		QueryableObjectInterface leftEntity = expression.getQueryEntity()
//				.getDynamicExtensionsEntity();
//		QueryableObjectInterface superClassEntity = leftEntity.getParentEntity();
//		// processing Parent class heirarchy.
//		if (superClassEntity != null)
//		{
//			QueryableObjectInterface theLeftEntity = leftEntity;
...
//				// here.
//				{
//					QueryableAttributeInterface primaryKey = getPrimaryKey(theLeftEntity);
...
//				QueryableObjectInterface rightEntity = QueryableObjectUtility
//						.createQueryableObject(eavAssociation.getTargetEntity());
...
//								eavAssociation);
//						rightEntity = QueryableObjectUtility.createQueryableObject(eavAssociation
//								.getTargetEntity());
//
//						leftAlias = getAliasFor(parentExpression, QueryableObjectUtility
//								.createQueryableObject(eavAssociation.getEntity()));
//						rightAlias = getAliasFor(childExpression, rightEntity);
//					}
//					else
//					{
//						leftAlias = getAliasFor(parentExpression, QueryableObjectUtility
...
//					}
//
//					QueryableObjectInterface childEntity = childExpression.getQueryEntity()
//							.getDynamicExtensionsEntity();
//
...
//							{
//								buffer.append(getDescriminatorCondition(QueryableObjectUtility
//										.createQueryableObject(actualEavAssociation.getEntity()),
//										leftAlias));
//							}
...
//							 */
//							buffer.append(
//									getDescriminatorCondition(QueryableObjectUtility
//											.createQueryableObject(actualEavAssociation
...
//	 *         TABLE_PER_HEIRARCHY.
//	 */
//	protected String getDescriminatorCondition(QueryableObjectInterface entity, String aliasName)
//	{
//		String sql = null;
...
//	 * @throws SqlException when there is error in the passed IQuery object.
//	 */
//	private String getParentHeirarchy(IExpression childExpression,
//			QueryableObjectInterface childEntity, QueryableObjectInterface alreadyAddedEntity)
//			throws SqlException
//	{
...
//		{
//			QueryableObjectInterface entity = childEntity;
//			QueryableObjectInterface parent = childEntity.getParentEntity();
...
//					QueryableAttributeInterface primaryKey = getPrimaryKey(entity);
//					String primaryKeyColumnName = primaryKey.getColumnProperties().getName();
//
...
//		QueryableAttributeInterface attributeObj = getActivityStatusAttribute(expression
//				.getQueryEntity().getDynamicExtensionsEntity());
//
//		if (attributeObj != null)
//		{
...
//	 */
//	private QueryableAttributeInterface getActivityStatusAttribute(
//			QueryableObjectInterface entityInterfaceObj)
//	{
//		Collection<QueryableAttributeInterface> attributes = entityInterfaceObj
//				.getEntityAttributesForQuery();
//
//		for (QueryableAttributeInterface attribute : attributes)
//		{
//			if (attribute.getName().equals(Status.ACTIVITY_STATUS))
//			{
//				return attribute;
//			}
//		}
...
//	{
//
//		QueryableAttributeInterface actualAttribute = attribute;
//
//		if (attribute.isInheritedAttribute())
//		{
//			actualAttribute = InheritanceUtils.getInstance().getActualAttribute(attribute);
//		}
//		QueryableObjectInterface attributeEntity = actualAttribute.getActualEntity();
...
//			{
//				Date date = new Date();
//				date = edu.wustl.common.util.Utility.parseDate(value);
//
...
//	}
//
//	private String getSelectForOutputTerms(List<IOutputTerm> terms) throws SqlException
//	{
...
//	}
//	
//	protected String getTemporalAttributeName(
//			QueryableAttributeInterface attribute, IExpression expression)
//	{
//		return getConditionAttributeName(attribute, expression);
//		
//	}
//	
//	@Override
//	protected boolean isParametrizedAttribute(QueryableAttributeInterface attribute, IExpression expression)
//	{
//		return false;
//	}
//
