...
function submitForm()
{
	//document.forms[0].action = "CiderExportData.do";
	//document.forms[0].submit();

	var url="CiderExportData.do";
	...
	request.send("");
	document.getElementById("exportMessageDiv").style.display="block";
	//confidentialitywindow.hide();
...
<tr>
	<td class = "info_msg"  colspan="2" valign="middle">
		<div id = "treeMessageDiv" style = "padding-left:10px;padding-bottom:5px;padding-top:5px" >
		</div>
	</td>
</tr>
<tr>
