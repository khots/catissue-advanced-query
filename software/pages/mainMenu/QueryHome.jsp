...
<link rel="stylesheet" type="text/css" href="css/advancequery/menus.css" />
<link rel="stylesheet" type="text/css" href="css/advancequery/examples.css" />
<link rel="stylesheet" type="text/css" href="css/advancequery/ext-all.css" />
<link rel="stylesheet" type="text/css" href="css/advancequery/catissue_suite.css" />
<script type="text/javascript" src="jss/advancequery/caTissueSuite.js"></script>
<script type="text/javascript" src="jss/advancequery/ext-base.js"></script>
<script type="text/javascript" src="jss/advancequery/ext-all.js"></script>
...
<table width="95%" cellspacing="0" cellpadding="0" border="0" align="top">
	<tr>
		<td width="5%" valign="top"><img width="48" height="24"
			src="images/advancequery/uIEnhancementImages/menustartimg.gif" /></td>
		<td width="95%" align="left">
		<logic:notEmpty scope="session"
			name="<%=Constants.SESSION_DATA%>">
			<script type="text/javascript" src="jss/advancequery/menus.js"></script>
			<div id="toolbarLoggedIn"></div>
		</logic:notEmpty>
		<logic:empty scope="session" name="<%=Constants.SESSION_DATA%>">
			<script type="text/javascript" src="jss/advancequery/menu_home.js"></script>
